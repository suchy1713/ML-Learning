{
  ...
  "metadata": {
    "colab": {
      ...
      "provenance": [],
      "authorship_tag": "ABX9TyM1BW81KtJoRTH98TTWD52i",
  ...
  "cells": [
    {
      ...
      "source": [
        "<a href=\"https://colab.research.google.com/github/suchy1713/ML-Learning/blob/master/utils/genetuning.py\" target=\"_parent\"><img src=\"https://colab.research.google.com/assets/colab-badge.svg\" alt=\"Open In Colab\"/></a>"
      ]
    },
    {
      "cell_type": "code",
      ...
      "source": [
        "#genetical algorithm-based fine-tuning\n",
        "\n",
        "import numpy as np\n",
        "import random\n",
        ...
        "            print('Generation ', i+1, ': ', self.scores)\n",
        ...
        "\n",
        "            print('Fitting model', idx+1, '/', len(self.population))\n",
